 ...
 * 이 때 main ival이 먼저 출력되는가? 아니면 sub ival이 먼저 출력 되는가?
...
public class TestParam {
	void effectParam(Param p) { //원본을 받았으나(21번이 주석이아닐때)
		//p = new Param(); //여기서 복제본 새로 생성됨(21번이 주석이 아닐때)
		p.ival = 500; //복제본이 500으로 변경(21번이 주석이 아닐때)
	...
	public static void main(String[] args) {
		...
		Param p = new Param(); //지변이지만 원본 변수 p의 주.변
		p.ival = 100;
		tp.effectParam(p); //동일한 주.변
		System.out.println("main ival ===> " + p.ival); //500, 100(21번이 주석이 아닐때)
	}//end of main
