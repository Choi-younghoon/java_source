...
public class Sonata {
	//insert here
	String carColor = null;//참조형(reference type-주소번지출력) 타입을 선언할 때 쓰는 예약어.
	int speed = 50;//전역변수 - 초기화를 생략할 수 있다. 왜 안해도 될까? : 생성자가 해주니깐...
	public static void main(String[] args) {
		...
		//전역변수는 클래스 전역에서 사용할 수 
		Sonata mycar = new Sonata();
		mycar.carColor = "빨강";
		System.out.println(mycar.carColor);
		System.out.println("빨강");
		//소나타 클래스 안에서 티볼리 안에 있는 변수나 메소드를 누릴(호출) 수 있다.
